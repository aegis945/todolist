const createSidebar = () => {
    ...
    sidebar.classList.add('hidden', 'md:block', 'md:w-1/5', 'text-white', 'bg-sky-900', 'border-solid', 'rounded-lg', 'ml-2', 'mt-10', 'pb-6');

    sidebar.innerHTML = `
        <div class="text-center py-3 text-lg font-bold text-sky-600">Filters</div>
        <div class="flex flex-col py-4 space-y-4 px-4">
            <div class="flex justify-between bg-sky-600 border border-sky-600 rounded-md py-2 px-3 hover:bg-sky-950 transition duration-300">
                <div><a class="text-sky-200">All Tasks</a></div>
                <img src="/src/icons/all-tasks.svg" alt="All Tasks" class="w-6 h-6">
            </div>
            <div class="flex justify-between bg-sky-600 border border-sky-600 rounded-md p-2 px-3 hover:bg-sky-950 transition duration-300">
